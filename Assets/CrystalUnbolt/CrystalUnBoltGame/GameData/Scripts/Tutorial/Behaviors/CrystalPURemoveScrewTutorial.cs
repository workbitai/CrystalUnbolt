...
namespace CrystalUnbolt
{
    ...
    public class CrystalPURemoveScrewTutorial : CrystalBaseTutorial
    {
        private readonly CrystalPUType POWER_UP_TYPE = CrystalPUType.RemoveScrew;

        [Space]
        [SerializeField] Color textHighlightColor = Color.red;

        [Space]
        [SerializeField] string firstMessage = "Use this booster to<br><color={0}>remove</color> a screw.";
        [SerializeField] string secondMessage = "<color={0}>Tap</color> on the screw to remove it!";
