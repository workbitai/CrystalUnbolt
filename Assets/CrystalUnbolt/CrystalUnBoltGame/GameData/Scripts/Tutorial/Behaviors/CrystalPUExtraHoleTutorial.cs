...
{
    public class CrystalPUExtraHoleTutorial : CrystalBaseTutorial
    {
        private readonly CrystalPUType POWER_UP_TYPE = CrystalPUType.AddExtraHole;

        [Space]
        [SerializeField] Color textHighlightColor = Color.red;

        [Space]
        [SerializeField] string firstMessage = "Use this booster to<br><color={0}>add</color> a new hole in the board.";
        [SerializeField] string secondMessage = "<color={0}>Tap</color> on the board<br>to add a hole!";
