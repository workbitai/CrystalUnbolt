...
namespace CrystalUnbolt
{
	...
	public class CrystalSlicedFilledImage : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
	{
...
#pragma warning restore 1692
		...
		protected CrystalSlicedFilledImage()
		{
...
#if UNITY_2017_4 || UNITY_2018_2_OR_NEWER
		private static List<CrystalSlicedFilledImage> m_TrackedTexturelessImages = new List<CrystalSlicedFilledImage>();
		...
		private static void RebuildImage(SpriteAtlas spriteAtlas)
		{
			...
			{
				CrystalSlicedFilledImage image = m_TrackedTexturelessImages[i];
