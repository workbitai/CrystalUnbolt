...
using System.Text;
using System.IO;
using CrystalUnbolt.List;

namespace CrystalUnbolt.SkinStore
{
    [CustomEditor(typeof(CrystalSkinStoreDatabase))]
    public class CrystalSkinsDatabaseEditor : Editor
    {
        //Settings section
        ...
        {
            CrystalEditorGUILayoutCustom.BeginBoxGroup("Settings");
        ...
        private float GetHeightForPurchaseTypeAndCurrencyField(SerializedProperty elementProperty, CustomListStyle style)
        {
            ...
            if (purchaseTypyProperty.intValue == (int)CrystalSkinStoreProductData.PurchaseType.InGameCurrency)
            {
        ...
        {
            CrystalEditorGUILayoutCustom.BeginBoxGroup("Product");
        ...
        {
            tabsRect = CrystalEditorGUILayoutCustom.BeginBoxGroup("Tabs");
    ...
    {
        private static readonly string TAB_TYPE_SCRIPT_NAME = "CrystalMD_SkinTab";
        private static readonly string PATH_SUFFICS = "\\CrystalMD_SkinTab.cs";
        ...
        private void UpdateEnum()
        {
            ...
            stringBuilder.Append("namespace CrystalUnbolt.SkinStore");
            stringBuilder.AppendLine();
