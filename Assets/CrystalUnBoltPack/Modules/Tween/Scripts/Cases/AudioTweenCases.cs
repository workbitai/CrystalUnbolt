...
namespace CrystalUnbolt
{
    public static class AudioTweenCases
    {
        ...
        /// </summary>
        public static AnimCase DOVolume(this AudioSource tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
