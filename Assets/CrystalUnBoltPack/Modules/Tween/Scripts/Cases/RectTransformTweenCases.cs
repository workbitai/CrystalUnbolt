...
namespace CrystalUnbolt
{
    public static class RectTransformTweenCases
    {
        ...
        /// </summary>
        public static AnimCase DOAnchoredPosition(this RectTransform tweenObject, Vector2 resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// Change anchored position of rectTransform
        /// </summary>
        public static AnimCase DOAnchoredPosition(this RectTransform tweenObject, Vector3 resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// Change anchored position of rectTransform
        /// </summary>
        public static AnimCase DOAnchoredPosition(this Graphic tweenObject, Vector2 resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// Change anchored position of rectTransform
        /// </summary>
        public static AnimCase DOAnchoredPosition(this Graphic tweenObject, Vector3 resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// Change anchored position of rectTransform
        /// </summary>
        public static AnimCase DOAnchoredPositionWithVerticalOffset(this RectTransform tweenObject, Vector2 resultValue, AnimationCurve verticalOffset, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// </summary>
        public static AnimCase DOAnchoredPositionShake(this RectTransform tweenObject, float magnitude, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// Shake object in 2D space
        /// </summary>
        public static AnimCase DOAnchoredPositionShake(this Graphic tweenObject, float magnitude, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// </summary>
        public static AnimCase DOSizeScale(this RectTransform tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// Change sizeDelta of rectTransform
        /// </summary>
        public static AnimCase DOSizeScale(this Graphic tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// Change sizeDelta of rectTransform
        /// </summary>
        public static AnimCase DOSize(this RectTransform tweenObject, Vector3 resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// Change sizeDelta of rectTransform
        /// </summary>
        public static AnimCase DOSize(this Graphic tweenObject, Vector3 resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
