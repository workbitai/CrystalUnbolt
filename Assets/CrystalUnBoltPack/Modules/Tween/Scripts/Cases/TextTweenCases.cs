...
namespace CrystalUnbolt
{
    public static class TextTweenCases
    {
        ...
        /// </summary>
        public static AnimCase DOFontSize(this Text tweenObject, int resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// Change text font size
        /// </summary>
        public static AnimCase DOFontSize(this TextMesh tweenObject, int resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// </summary>
        public static AnimCase DOFade(this TextMesh tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// </summary>
        public static AnimCase DOColor(this TextMesh tweenObject, Color resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
