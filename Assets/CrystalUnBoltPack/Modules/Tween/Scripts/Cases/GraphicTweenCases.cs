...
namespace CrystalUnbolt
{
    public static class GraphicTweenCases 
    {
        ...
        /// </summary>
        public static AnimCase DOColor(this Graphic tweenObject, Color resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod tweenType = UpdateMethod.Update)
        {
        ...
        /// </summary>
        public static AnimCase DOFade(this Graphic tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod tweenType = UpdateMethod.Update)
        {
