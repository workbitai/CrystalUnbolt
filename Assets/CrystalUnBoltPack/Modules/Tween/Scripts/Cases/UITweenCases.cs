...
namespace CrystalUnbolt
{
    public static class UITweenCases
    {
        ...
        /// </summary>
        public static AnimCase DOPreferredHeight(this LayoutElement tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// </summary>
        public static AnimCase DOFade(this CanvasGroup tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
