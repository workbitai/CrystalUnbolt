...
namespace CrystalUnbolt
{
    ...
    {
        #region Extensions
        public static AnimCase DOSize(this Camera tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        public static AnimCase DOFieldOfView(this Camera tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
