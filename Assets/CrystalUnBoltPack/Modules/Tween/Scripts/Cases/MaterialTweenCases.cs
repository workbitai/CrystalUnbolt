...
namespace CrystalUnbolt
{
    public static class MaterialTweenCases
    {
        ...
        /// </summary>
        public static AnimCase DOColor(this Material tweenObject, int colorID, Color resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// </summary>
        public static AnimCase DoFloat(this Material material, int floatId, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
