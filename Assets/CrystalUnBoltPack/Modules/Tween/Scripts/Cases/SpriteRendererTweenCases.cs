...
namespace CrystalUnbolt
{
    public static class SpriteRendererTweenCases
    {
        ...
        /// </summary>
        public static AnimCase DOColor(this SpriteRenderer tweenObject, Color resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
        ...
        /// </summary>
        public static AnimCase DOFade(this SpriteRenderer tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
