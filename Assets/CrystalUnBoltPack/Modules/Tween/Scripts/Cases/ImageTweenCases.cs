...
namespace CrystalUnbolt
{
    public static class ImageTweenCases
    {
        ...
        /// Change image fill
        /// </summary>
        public static AnimCase DOFillAmount(this Image tweenObject, float resultValue, float time, float delay = 0, bool unscaledTime = false, UpdateMethod updateMethod = UpdateMethod.Update)
        {
