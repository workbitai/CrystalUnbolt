...
namespace CrystalUnbolt
{
    ...
    public class FracturedExplosion
    {
        ...
        private AnimCase explodeTweenCase;
        ...
        public void Explode(GameCallback onExploded = null)
        {
            Explode(fracturedObject.transform.position, onExploded);
        }

        public void Explode(Vector3 epicenterPosition, GameCallback onExploded = null)
        {
